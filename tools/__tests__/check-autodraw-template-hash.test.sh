...
mkdir -p "$WORK/tools" "$WORK/packages/chain-algorand/src/card/api/escrow" "$WORK/packages/config/src"
...
cat >"$WORK/packages/chain-algorand/src/card/api/escrow/autodraw-teal.ts" <<TS
