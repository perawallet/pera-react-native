...
SECRETS=(
  ...
  "TESTNET_BACKEND_URL"
  "BACKEND_API_KEY"
  # Optional today: the v3 devices API falls back to BACKEND_API_KEY until the
  # backend issues this key. Aliased here so it reaches generate-config.sh the
  # moment it is added to Bitrise.
  "BACKEND_API_KEY_V3"
