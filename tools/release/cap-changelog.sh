...
# tools/release/cap-changelog.sh
...
#
# The per-section entry cap in generate-changelog.sh is not a substitute: it
...
#
# Usage: printf '%s' "$CHANGELOG" | tools/release/cap-changelog.sh [budget]
