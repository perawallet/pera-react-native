...
append_config "MAINNET_CARD_AUTODRAW_PROGRAM" "mainnetCardAutoDrawProgram" "string"
append_config "TESTNET_CARD_AUTODRAW_PROGRAM" "testnetCardAutoDrawProgram" "string"
