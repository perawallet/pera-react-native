...
// `keyValueStorage` too: `WithConnections` composes after the platform
// extension and refuses to build its store without one, so a platform stub
// that omits it fails provider construction outright.
