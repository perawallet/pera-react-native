...
import { usePushNotificationService } from '../index'
import { type PushNotificationService } from '../../models'

describe('services/push-notifications/hooks/usePushNotificationService', () => {
    test('usePushNotificationService resolves the registered PushNotificationService from the provider', async () => {
        ...
        registerTestPlatform({ pushNotification: dummy })
