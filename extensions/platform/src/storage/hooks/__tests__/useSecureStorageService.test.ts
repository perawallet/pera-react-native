...
import { useSecureStorageService } from '../index'

describe('useSecureStorageService tests', () => {
    test('useSecureStorageService resolves the registered SecureStorageService from the provider', async () => {
        ...
        registerTestPlatform({ secureStorage: dummy })
