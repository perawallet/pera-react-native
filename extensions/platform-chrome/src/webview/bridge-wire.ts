...
// and Bidali webviews. MUST stay free of chrome.* usage and side effects:
...
export const WEBVIEW_BRIDGE_PORT_PREFIX = 'pera-discover-bridge:'

/** Query-param name the bridge token is passed under on the iframe URL. */
export const WEBVIEW_BRIDGE_TOKEN_PARAM = 'peraBridgeToken'

/** window event the MAIN-world script uses to announce itself to the
 * ISOLATED relay content script (same document, cross-world). */
export const WEBVIEW_BRIDGE_HANDSHAKE_EVENT = '__pera_discover_handshake__'
...
export const WEBVIEW_BRIDGE_RELAY_READY_EVENT = '__pera_discover_relay_ready__'
