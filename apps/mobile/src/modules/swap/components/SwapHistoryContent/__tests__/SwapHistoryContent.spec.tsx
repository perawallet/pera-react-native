...
const renderWithId = (id = 'sheet-1') =>
    render(
        <BottomSheetIdContext.Provider value={id}>
            <SwapHistoryContent address='ADDRESS' />
        </BottomSheetIdContext.Provider>,
    )

describe('SwapHistoryContent', () => {
    beforeEach(() => {
    ...
    it('renders the history list and title', () => {
    ...
    it('dismisses the sheet and opens the explorer when an item is tapped', async () => {
        mockUseSwapHistoryInfiniteQuery.mockReturnValue({
