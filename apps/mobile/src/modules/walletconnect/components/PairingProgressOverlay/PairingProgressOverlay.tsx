...
// The OS deep link gives the user no other feedback for the whole outcome wait
// (up to 15s); without this scrim a slow pairing looks like the tap did nothing.
