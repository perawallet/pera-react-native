...
describe('useRekeyToLedgerSuccessScreen', () => {
    beforeEach(() => {
        vi.clearAllMocks()
    ...
    it('returns the account display name as sourceName when the account is found', () => {
        const { result } = renderHook(() => useRekeyToLedgerSuccessScreen())
