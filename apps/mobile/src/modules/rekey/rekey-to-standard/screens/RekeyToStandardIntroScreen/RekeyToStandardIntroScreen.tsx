...
export const RekeyToStandardIntroScreen = () => {
    ...
    const expectations = useMemo(
        () => [
            t('rekey.to_standard.intro.expect_1'),
            t('rekey.to_standard.intro.expect_2'),
            t('rekey.to_standard.intro.expect_3'),
        ],
        [t],
    )
    ...
    return (
        <PWView
            style={styles.root}
            testID='rekey-to-standard-intro-screen'
        >
            <PWScrollView contentContainerStyle={styles.scrollContent}>
                ...
                <PWView style={styles.body}>
                    <PWText variant='h1'>
                        {t('rekey.to_standard.intro.title')}
                    </PWText>
                    ...
                    >
                        {t('rekey.to_standard.intro.body')}{' '}
                        <PWText
                            variant='bodyLarge'
                            style={styles.learnMore}
                            onPress={handleLearnMore}
                        >
                            {t('rekey.to_standard.intro.learn_more')}
                        </PWText>
                    </PWText>
                    ...
                    <PWView style={styles.listSection}>
                        ...
                        >
                            {t('rekey.to_standard.intro.expect_label')}
                        </PWText>
            ...
            <PWView style={styles.footer}>
                <PWButton
                    variant='primary'
                    title={t('rekey.to_standard.intro.cta')}
                    onPress={handleStartProcess}
                    style={styles.cta}
                    testID='rekey-to-standard-intro-start'
                />
            </PWView>
        </PWView>
    )
