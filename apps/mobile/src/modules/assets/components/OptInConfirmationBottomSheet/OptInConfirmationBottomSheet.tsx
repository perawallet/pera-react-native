...
export type OptInConfirmationBottomSheetProps = {
    isVisible: boolean
    onClose: () => void
...
export const OptInConfirmationBottomSheet = ({
    isVisible,
    onClose,
    assetId,
    accountAddress,
    onConfirmOptIn,
    isLoading,
}: OptInConfirmationBottomSheetProps) => {
            ...
            <SafeAreaView edges={['bottom']}>
                ...
                <PWView style={styles.body}>
                    ...
                    <PWView style={styles.buttonContainer}>
                        <PWButton
                            title={t('add_asset.confirmation.approve')}
                            variant='primary'
                            onPress={onConfirmOptIn}
                            isLoading={isLoading}
