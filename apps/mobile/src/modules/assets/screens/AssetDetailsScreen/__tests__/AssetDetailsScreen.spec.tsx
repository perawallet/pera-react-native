...
vi.mock('@perawallet/wallet-core-accounts', async () => {
    ...
    return {
        ...
        useSelectedAccount: vi.fn(() => ({ address: 'test-address', name: 'Test Wallet' })),
...
vi.mock('@components/core/PWTabView/PWTabView', () => ({
    createPWTabNavigator: () => ({
        ...
        Screen: ({ children }: any) => {
             ...
             return typeof children === 'function' ? children({ navigation: {} }) : children
        },
    }),
}))
...
describe('AssetDetailsScreen', () => {
    it('renders the custom toolbar with account name and truncated address', () => {
        render(<AssetDetailsScreen route={{ params: { assetId: '123' } } as any} navigation={{ setOptions: vi.fn() } as any} />)
