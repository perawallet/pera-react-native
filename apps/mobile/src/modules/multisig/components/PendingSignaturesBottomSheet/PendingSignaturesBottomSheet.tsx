...
export const PendingSignaturesBottomSheet = () => {
    ...
    return (
        <>
            <PWBottomSheet
                ...
                testID='pending_signatures_bottom_sheet'
            >
                        ...
                        <PWView style={styles.actionsRow}>
                            {canSign && (
                                <PWButton
                                    variant='primary'
                                    title={t(
                                        'multisig.pending_signatures.sign',
                                    )}
                                    onPress={handleSign}
                            ...
                            {canCancel && (
                                <PWButton
                                    variant='secondary'
                                    title={t(
                                        'multisig.cancel_transaction.button',
                                    )}
            ...
            <ConfirmActionBottomSheet
                ...
                confirmLabel={t('multisig.cancel_transaction.confirm_action')}
                cancelLabel={t('multisig.cancel_transaction.keep_waiting')}
