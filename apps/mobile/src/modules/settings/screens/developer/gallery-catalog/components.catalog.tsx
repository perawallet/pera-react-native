    ...
    render: () => (
        <VariantPreview
            items={[
                ...
                {
                    label: 'h2',
                    node: <PWText variant='h2'>Heading 2 — section title</PWText>,
                },
                {
                    label: 'h3',
                ...
                {
                    label: 'body',
                    node: <PWText variant='body'>Body — regular prose text</PWText>,
                },
                {
                    label: 'bodyLarge',
                    node: (
                ...
                {
                    label: 'caption',
                    node: <PWText variant='caption'>Caption — small label</PWText>,
                },
                {
                    label: 'captionMedium',
                    node: (
                ...
                },
                {
                    ...
                    node: (
                        <PWText variant='body'>
                            This is a longer paragraph of body text to demonstrate
                            how PWText wraps gracefully across multiple lines when
                            the content exceeds the available horizontal width.
                        </PWText>
                    ),
                },
                {
            ...
            items={[
                ...
                },
                {
                    ...
                    node: (
                        <PWDropdown
                            items={[
                                { label: 'Edit', icon: 'edit-pen', onPress: () => undefined },
                                {
                                    label: 'Delete',
                                    icon: 'trash',
                                    variant: 'destructive',
