...
type UseCloudBackupIntroductionResult = {
    isIntroductionSeen: boolean
    markIntroductionSeen: () => void
}

export const useCloudBackupIntroduction =
    (): UseCloudBackupIntroductionResult => {
        ...
        const markIntroductionSeen = useCallback(() => {
            setPreference(UserPreferences.cloudBackupIntroSeen, true)
        }, [setPreference])
