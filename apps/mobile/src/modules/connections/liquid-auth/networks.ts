...
import type { LiquidAuthNetwork } from '@perawallet/wallet-core-liquid-auth'
 ...
 * network. The app only models mainnet/testnet (see `Networks`); betanet
 * genesis values are retained in `ALGORAND_GENESIS` for completeness but are
 * not reachable here.
 */
