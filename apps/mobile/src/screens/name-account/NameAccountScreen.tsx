...
import { useAccounts, useDisplayAddress, WalletAccount } from '@perawallet/core';
  ...
  return (
    <MainScreenLayout title="Name your account" showBack>
      <KeyboardAvoidingView style={styles.mainContainer} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
        <Text h4 style={styles.helperText}>Name your account to easily identify it while using the Pera Wallet. These names are stored locally, and can only be seen by you.</Text>
        ...
        <Input label="Account name" containerStyle={styles.input} value={walletDisplay} onChangeText={saveName} autoFocus />
        <PeraView style={styles.spacer} />
        <PeraButton style={styles.finishButton} variant="primary" title="Finish Account Creation" onPress={goToHome}/>
