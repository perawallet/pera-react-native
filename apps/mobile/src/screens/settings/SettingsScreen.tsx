...
const settingsOptions = [
    {
        ...
        items: [
            ...
            { route: 'SettingsSubPage', icon: <ShieldIcon />, title: 'Notifications' },
            { route: 'SettingsSubPage', icon: <ShieldIcon />, title: 'WalletConnect Sessions' },
        ]
    },
    {
    ...
    },
    {
        ...
        items: [
            ...
            { route: 'SettingsSubPage', icon: <ShieldIcon />, title: 'Rate Pera Wallet' },
            { route: 'SettingsSubPage', icon: <ShieldIcon />, title: 'Terms and Services' },
            { route: 'SettingsSubPage', icon: <ShieldIcon />, title: 'Privacy Policy' },
            { route: 'SettingsSubPage', icon: <ShieldIcon />, title: 'Developer Settings' },
        ]
    }
]
            ...
            <PeraView style={styles.sectionContainer}>
                {
                    settingsOptions.map((item) => (
                        <PeraView style={styles.section} key={`settings-section-${item.title}`}>
                            <Text style={styles.sectionTitle}>{item.title}</Text>
                            {
                                item.items.map((page) => (
                                    <TouchableOpacity style={styles.sectionRow} key={`settings-sectionrow-${page.title}`} onPress={() => goToSettingsPage(page.route, page.title)}>
                                        {page.icon}
