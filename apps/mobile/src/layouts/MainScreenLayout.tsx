...
const MainScreenLayout = (props: MainScreenLayoutProps) => {
    ...
    return props.fullScreen ? (
        <PeraView style={[props.style, styles.mainContainer]} {...props}>
            {props.showBack && <ChevronLeft stroke={theme.colors.textMain} onPress={goBack} style={styles.backContainer} />}
            {props.title && <Text h1 style={styles.title}>{props.title}</Text>}
