...
export type ScreenState = "select-asset" | "input-amount" | "select-destination" | "confirm-transaction"
        ...
        <SendFundsProvider>
            {!!selectedAccount ? 
                ...
                animationConfig={{duration: 200, useNativeDriver: true}} disableSwipe>
                    ...
                    <TabView.Item style={styles.tabItem}>
                        <SendFundsInputView onNext={handleNext} onBack={handleBack}/>
                    </TabView.Item>
                    <TabView.Item style={styles.tabItem}>
                        <SendFundsSelectDestination onNext={handleNext} onBack={handleBack}/>
                    </TabView.Item>
                    <TabView.Item style={styles.tabItem}>
                        <SendFundsTransactionConfirmation onNext={handleNext} onBack={handleBack} />
                    </TabView.Item>
                </TabView>
