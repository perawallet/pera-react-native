...
describe('Flow: Pera 6 migration → asset inbox', () => {
    // Unmount first — see messages.spec.tsx: resetting handlers while a
    ...
    it('migrated accounts (incl. rekeyed) appear in the inbox request and ASA rows render', async () => {
        ...
        // the integration setup, as in messages.spec.tsx).
        await waitFor(
            () => {
                expect(
