...
//
// Stops at asserting the sheet appears: rekey-out can't actually be signed
// today (useLocalKeyTransactionSigner rejects quantum accounts), but that gap
// sits after the sheet in the confirm flow.
