...
// store. No HTTP calls are needed for the create path, so any MSW
// unhandled-request warning here is unexpected.
...
describe('Flow: Onboarding → Create wallet', () => {
    ...
    it('Given the user taps "Create wallet" and finishes naming, then a single HD wallet account is persisted and onboarding completes', async () => {
        ...
        fireEvent.click(screen.getByTestId('onboarding_create_wallet_button'))
    ...
    it('Given the user changes the wallet name, then the persisted account uses that name', async () => {
        renderWithNavigation(OnboardingScreen, 'Onboarding', {
            additionalScreens: [
                { name: 'NameAccount', component: NameAccountScreen },
            ],
    ...
    it('Given the create button is tapped, when the work is in flight, then the loading overlay is rendered', async () => {
        renderWithNavigation(OnboardingScreen, 'Onboarding', {
            additionalScreens: [
                { name: 'NameAccount', component: NameAccountScreen },
            ],
