...
describe('Flow: Ledger import upgrades a watch account', () => {
    ...
    it('Given the Ledger address exists as a watch account, when the user imports it and confirms the upgrade, then the watch account becomes a signable hardware account with its name preserved', async () => {
        renderImportFlow()
    ...
    it('Given the Ledger address exists as a watch account, when the user declines the upgrade, then nothing is written and the flow stays on the verify screen', async () => {
        renderImportFlow()
