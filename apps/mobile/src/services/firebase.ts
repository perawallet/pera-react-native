...
import { CrashReportingService, NotificationsInitResult, RemoteConfigKey, RemoteConfigService } from '@perawallet/core';

export class RNFirebaseService implements CrashReportingService, RemoteConfigService, CrashReportingService {
