...
vi.mock('@perawallet/wallet-core-shared', async () => ({
    ...
    // OFF-004 mutation policy. `mutationDefaults` is read at module-eval time by
    // QueryProvider, so it must be a real object (not a vi.fn). Mirrors
    // packages/shared/src/api/mutation-policy.ts.
