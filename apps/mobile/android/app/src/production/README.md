...
Place your Firebase `google-services.json` file for the **production** environment in this directory.
...
4. Under "Your apps", find the Android app with package name: `com.algorand.android.perarn`
5. Download the `google-services.json` file
6. Place it in this directory: `apps/mobile/android/app/src/production/google-services.json`
