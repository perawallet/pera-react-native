...
//   (apps/extension/src/content/connect-modal-uri.ts:19)
// - INJECTED_ROW_ID = 'pera-extension-injected-row'
//   (apps/extension/src/content/connect-modal-row.ts:24)
