...
import { type Network, isMainnet } from '@perawallet/wallet-core-config'
...
export const getUsdcAssetId = (network: Network): string =>
    isMainnet(network) ? USDC_ASSET_ID_MAINNET : USDC_ASSET_ID_TESTNET
