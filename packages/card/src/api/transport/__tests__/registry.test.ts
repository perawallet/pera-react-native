...
// default-transport pulls the integrity policy for proxy headers; stub it so
// the app-integrity store (and its shared/registerStore import) stays out of
// this registry-focused test.
