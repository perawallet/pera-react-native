...
export type UseCardPinViewMutationResult = CardMutationResult<
    void,
    CardSecureView
>
 ...
 */
export const useCardPinViewMutation = (): UseCardPinViewMutationResult => {
    const { network } = useNetwork()

    const mutation = useMutation<CardSecureView, Error, void>({
        mutationFn: () => fetchCardPinToken({ network }),
        throwOnError: false,
    })
