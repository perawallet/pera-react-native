...
export const useHDWallet = () => {
    ...
    return {
        ...
        deriveKey: async ({
            ...
            const address = await api.keyGen(rootKey, KeyContext.Address, account, keyIndex, derivationType)
...
export const useAccounts = () => {
	...
	return {
		...
		createAccount: async ({ walletId, account, keyIndex }: { walletId?: string, account: number, keyIndex: number }) => {
