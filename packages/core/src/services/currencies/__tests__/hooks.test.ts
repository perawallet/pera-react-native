...
describe('services/currencies/hooks', () => {
  ...
  describe('useCurrency', () => {
    it('returns preferredCurrency and setPreferredCurrency from store', () => {
      ...
      expect(result.current.setPreferredCurrency).toBe(mockSetPreferredCurrency);
    });
  ...
  describe('useCurrencyConverter', () => {
    it('returns convertUSDToPreferredCurrency function', () => {
      ...
      expect(typeof result.current.convertUSDToPreferredCurrency).toBe('function');
    });
    ...
    it('converts USD to preferred currency correctly', () => {
      ...
      const converted = result.current.convertUSDToPreferredCurrency(usdAmount);
