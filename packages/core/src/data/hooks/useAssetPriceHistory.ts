...
import type {
    ...
    AssetPriceHistoryQueryParams,
} from '../types/AssetPriceHistory'
import type {
    QueryKey,
    QueryClient,
...
export const useAssetPriceHistoryQueryKeys = (
    params: AssetPriceHistoryQueryParams,
) => [AssetPriceHistoryQueryKey(params)]

export const AssetPriceHistoryQueryKey = (
    params: AssetPriceHistoryQueryParams,
) => [{ url: '/v1/assets/price-chart/' }, ...(params ? [params] : [])] as const

export type AssetPriceHistoryQueryKey = ReturnType<
    typeof AssetPriceHistoryQueryKey
>

export async function AssetPriceHistoryRequest(
    { params }: { params: AssetPriceHistoryQueryParams },
    config: Partial<RequestConfiguration> & { client?: typeof fetch } = {},
) {
...
export function useAssetPriceHistory<
    TData = AssetPriceHistoryResponse,
    TQueryData = AssetPriceHistoryResponse,
    TQueryKey extends QueryKey = AssetPriceHistoryQueryKey,
>(
    { params }: { params: AssetPriceHistoryQueryParams },
    options: {
        query?: Partial<
    ...
    const query = useSuspenseQuery(
        ...
        queryClient,
    ) as UseSuspenseQueryResult<TData, ResponseErrorConfiguration<Error>> & {
        queryKey: TQueryKey
    }
