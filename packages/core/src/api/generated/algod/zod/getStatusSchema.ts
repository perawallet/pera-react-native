...
export const getStatus200Schema = z.object({
...
export type GetStatus200Schema = z.infer<typeof getStatus200Schema>

/**
 * @description Invalid API Token
 */
export const getStatus401Schema = z.lazy(() => errorResponseSchema).describe("An error response with optional data field.")

export type GetStatus401Schema = z.infer<typeof getStatus401Schema>

/**
 * @description Internal Error
 */
export const getStatus500Schema = z.string()

export type GetStatus500Schema = z.infer<typeof getStatus500Schema>
...
export type GetStatusErrorSchema = z.infer<typeof getStatusErrorSchema>

export const getStatusQueryResponseSchema = z.lazy(() => getStatus200Schema)

export type GetStatusQueryResponseSchema = z.infer<typeof getStatusQueryResponseSchema>