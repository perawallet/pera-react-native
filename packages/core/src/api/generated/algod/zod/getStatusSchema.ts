 ...
 */
export const getStatus401Schema = errorResponseSchema.describe("An error response with optional data field.")
...
export const getStatusQueryResponseSchema = getStatus200Schema
