...
export type WaitForBlockPathParams = {
    /**
...
*/
export type WaitForBlock400 = ErrorResponse;

/**
 * @description Invalid API Token
*/
export type WaitForBlock401 = ErrorResponse;

/**
 * @description Internal Error
*/
export type WaitForBlock500 = ErrorResponse;

/**
 * @description Service Temporarily Unavailable
*/
export type WaitForBlock503 = ErrorResponse;

/**
 * @description Unknown Error
*/
export type WaitForBlockError = unknown;

export type WaitForBlockQueryResponse = WaitForBlock200;

export type WaitForBlockQuery = {
    Response: WaitForBlock200;
    PathParams: WaitForBlockPathParams;
    Errors: WaitForBlock400 | WaitForBlock401 | WaitForBlock500 | WaitForBlock503;
};