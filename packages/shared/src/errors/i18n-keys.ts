...
export const ERROR_I18N_KEYS = {
    ...
    // KMS errors
    KEY_NOT_FOUND: 'errors.kms.key_not_found',
    KEY_ACCESS: 'errors.kms.key_access_error',
    INVALID_KEY: 'errors.kms.invalid_key',
    ...
    TRANSACTIONS_INVALID_SEND_PARAMS: 'errors.transaction.invalid_send_params',
} as const
