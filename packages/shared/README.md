...
```sh
pnpm --filter @perawallet/wallet-core-shared build
pnpm --filter @perawallet/wallet-core-shared test
pnpm --filter @perawallet/wallet-core-shared test:watch
pnpm --filter @perawallet/wallet-core-shared lint
```
