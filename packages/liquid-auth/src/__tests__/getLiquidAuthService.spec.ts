...
import { getLiquidAuthService } from '../hooks/getLiquidAuthService'
import { LiquidAuthServiceUnavailableError } from '../errors'

describe('getLiquidAuthService', () => {
    ...
    it('returns the liquidAuth service when present', () => {
        ...
        expect(getLiquidAuthService()).toBe(liquidAuth)
    })

    it('throws when the extension is not composed', () => {
        getProviderMock.mockReturnValue({})
        expect(() => getLiquidAuthService()).toThrow(
