 ...
 * `WithLiquidAuth` has not been composed into the provider. A plain getter
 * (no React subscription), so it is not prefixed `use`.
 */
export const getLiquidAuthService = (): LiquidAuthExtension['liquidAuth'] => {
