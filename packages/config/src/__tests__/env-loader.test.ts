...
describe('env-loader', () => {
    ...
    describe('getConfigWithEnvOverrides', () => {
        const mockBaseConfig: Config = {
            ...
            betanetAlgodUrl: 'https://base-betanet-algod.example.com',
            betanetIndexerUrl: 'https://base-betanet-indexer.example.com',
            betanetGenesisHash: 'base-betanet-genesis-hash',
            betanetExplorerUrl: 'https://betanet-explorer.example.com',
            fnetAlgodUrl: 'https://base-fnet-algod.example.com',
            fnetIndexerUrl: 'https://base-fnet-indexer.example.com',
            fnetGenesisHash: 'base-fnet-genesis-hash',
            fnetExplorerUrl: 'https://fnet-explorer.example.com',
            localnetAlgodUrl: 'https://base-localnet-algod.example.com',
            localnetIndexerUrl: 'https://base-localnet-indexer.example.com',
            localnetExplorerUrl: 'https://localnet-explorer.example.com',
            localnetAlgodToken: 'base-localnet-algod-token',
            mainnetDispenserUrl: 'https://base-mainnet-dispenser.example.com',
            ...
            mainnetCardEscrowBaseUrl: 'https://escrow.example.com',
            testnetCardEscrowBaseUrl: 'https://escrow.testnet.example.com',
            mainnetCardEscrowAuthToken: 'test-mainnet-escrow-token',
            testnetCardEscrowAuthToken: 'test-testnet-escrow-token',
            mainnetCardW3CardAppId: '1001',
