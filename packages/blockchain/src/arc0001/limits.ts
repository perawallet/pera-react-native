...
//
// Kept free of imports — zod included — so the extension's service-worker
// payload gate can enforce the same cap without pulling the schema graph.

/** Per-transaction base64 cap; the wire gate in the extension mirrors it. */
export const ARC0001_MAX_TXN_B64_LENGTH = 64 * 1024
export const MAX_MESSAGE_LENGTH = 4 * 1024
export const MAX_ADDRESS_LENGTH = 128
export const MAX_ADDRESS_LIST_LENGTH = 256
