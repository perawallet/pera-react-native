...
import { useDeviceInfoService } from '../index'
...
describe('services/device/platform-service', () => {
    ...
    test('useDeviceInfoService resolves the registered DeviceInfoService from the provider', () => {
        const dummy = createMockDeviceInfoService()
        registerTestPlatform({ deviceInfo: dummy })
