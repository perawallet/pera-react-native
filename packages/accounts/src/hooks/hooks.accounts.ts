...
import { encodeAlgorandAddress } from '@perawallet/wallet-core-shared'
...
export const useCreateAccount = () => {
    ...
    const { mutateAsync: updateDeviceOnBackend } = useUpdateDevice()
    ...
    return async ({
        ...
        if (deviceID) {
            updateDeviceOnBackend({
                deviceId: deviceID,
                data: {
                    platform: deviceInfo.getDevicePlatform() as DevicePlatform,
